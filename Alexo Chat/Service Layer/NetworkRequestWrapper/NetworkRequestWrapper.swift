...
protocol NetworkRequestWrapperProtocol {
    func runRequest(_ request: NetworkRequest, baseURL: String, authToken: String, bearerToken: String?, progressResult: ((Double) -> Void)?, completion: @escaping(_ statusCode: Int, _ requestData: Data?, _ error: NetworkError?) -> Void)
}
